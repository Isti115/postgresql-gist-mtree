...
CREATE OR REPLACE FUNCTION mus_gist_in(cstring) RETURNS mus_gist AS
  '/home/donkoistvan/PostgreSQL_11/install/lib/mus_gist_type_static.so', 'mus_gist_in'
  LANGUAGE c IMMUTABLE STRICT;

CREATE OR REPLACE FUNCTION mus_gist_out(mus_gist) RETURNS cstring AS
  '/home/donkoistvan/PostgreSQL_11/install/lib/mus_gist_type_static.so', 'mus_gist_out'
  LANGUAGE c IMMUTABLE STRICT;

-- CREATE OR REPLACE FUNCTION mus_gist_recv(
--     internal)
-- RETURNS mus_gist AS
-- '/home/donkoistvan/PostgreSQL_11/install/lib/mus_gist_type_static.so', 'mus_gist_recv'
--   LANGUAGE c IMMUTABLE STRICT;
--   
-- CREATE OR REPLACE FUNCTION mus_gist_send(
--     mus_gist)
-- RETURNS bytea AS
-- '/home/donkoistvan/PostgreSQL_11/install/lib/mus_gist_type_static.so', 'mus_gist_send'
--   LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION mus_gist_same(mus_gist, mus_gist) RETURNS bool AS
  '/home/donkoistvan/PostgreSQL_11/install/lib/mus_gist_type_static.so', 'mus_gist_same'
  LANGUAGE c IMMUTABLE STRICT;

CREATE OR REPLACE FUNCTION mus_gist_distance(mus_gist, mus_gist) RETURNS integer AS
  '/home/donkoistvan/PostgreSQL_11/install/lib/mus_gist_type_static.so', 'mus_gist_distance'
  LANGUAGE c IMMUTABLE STRICT;

CREATE OR REPLACE FUNCTION mus_gist_overlap(mus_gist, mus_gist) RETURNS bool AS
  '/home/donkoistvan/PostgreSQL_11/install/lib/mus_gist_type_static.so', 'mus_gist_overlap'
  LANGUAGE c IMMUTABLE STRICT;
  
CREATE OR REPLACE FUNCTION mus_gist_contains(mus_gist, mus_gist) RETURNS bool AS
  '/home/donkoistvan/PostgreSQL_11/install/lib/mus_gist_type_static.so', 'mus_gist_contains'
  LANGUAGE c IMMUTABLE STRICT;
  
CREATE OR REPLACE FUNCTION mus_gist_contained(mus_gist, mus_gist) RETURNS bool AS
  '/home/donkoistvan/PostgreSQL_11/install/lib/mus_gist_type_static.so', 'mus_gist_contained'
  LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION mus_gist_compress(internal) RETURNS internal AS
  '/home/donkoistvan/PostgreSQL_11/install/lib/mus_gist_type_static.so', 'mus_gist_compress'
  LANGUAGE c IMMUTABLE STRICT;

CREATE OR REPLACE FUNCTION mus_gist_decompress(internal) RETURNS internal AS
  '/home/donkoistvan/PostgreSQL_11/install/lib/mus_gist_type_static.so', 'mus_gist_decompress'
  LANGUAGE c IMMUTABLE STRICT;

CREATE OR REPLACE FUNCTION mus_gist_consistent(internal, mus_gist, smallint, oid, internal) RETURNS bool AS
  '/home/donkoistvan/PostgreSQL_11/install/lib/mus_gist_type_static.so', 'mus_gist_consistent'
  LANGUAGE c IMMUTABLE STRICT;

CREATE OR REPLACE FUNCTION mus_gist_union(internal, internal) RETURNS mus_gist AS
  '/home/donkoistvan/PostgreSQL_11/install/lib/mus_gist_type_static.so', 'gist_union'
  LANGUAGE c IMMUTABLE STRICT;

CREATE OR REPLACE FUNCTION mus_gist_penalty(internal, internal, internal) RETURNS internal AS
  '/home/donkoistvan/PostgreSQL_11/install/lib/mus_gist_type_static.so', 'mus_gist_penalty'
  LANGUAGE c IMMUTABLE STRICT;

CREATE OR REPLACE FUNCTION mus_gist_picksplit(internal, internal) RETURNS internal AS
  '/home/donkoistvan/PostgreSQL_11/install/lib/mus_gist_type_static.so', 'gist_picksplit'
  LANGUAGE c IMMUTABLE STRICT;
  
CREATE OR REPLACE FUNCTION mus_gist_same_internal(mus_gist, mus_gist, internal) RETURNS internal AS
 '/home/donkoistvan/PostgreSQL_11/install/lib/mus_gist_type_static.so', 'mus_gist_same_internal'
  LANGUAGE c IMMUTABLE STRICT;

CREATE OR REPLACE FUNCTION mus_gist_distance_internal(internal, mus_gist, smallint, oid, internal) RETURNS float8 AS
 '/home/donkoistvan/PostgreSQL_11/install/lib/mus_gist_type_static.so', 'mus_gist_distance_internal'
  LANGUAGE c IMMUTABLE STRICT;
...
-- COPY songs (x, data) FROM '/home/donkoistvan/merged_small.csv' DELIMITER ',' CSV HEADER;
COPY songs (x, data) FROM '/home/donkoistvan/merged.csv' DELIMITER ',' CSV HEADER;
-- 
-- 
-- --- TEXT ---
-- 
-- CREATE OR REPLACE FUNCTION text_distance(text, text) RETURNS integer AS
--   '/home/donkoistvan/PostgreSQL_11/install/lib/mus_gist_type_static.so', 'text_distance'
--   LANGUAGE c IMMUTABLE STRICT;
-- 
...
-- COPY songs_text (x, data) FROM '/home/donkoistvan/merged_small.csv' DELIMITER ',' CSV HEADER;
-- COPY songs_text (x, data) FROM '/home/donkoistvan/merged.csv' DELIMITER ',' CSV HEADER;
